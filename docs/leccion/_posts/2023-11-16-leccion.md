...
summary: "Usando codespaces para ejecutar jekyll server"
categories: Clases
...
Esta es la primera prueba de usar jekyll dentro del container de codespaces.

Usaremos interpolación de una variable, como por ejemplo la variable Summary 
